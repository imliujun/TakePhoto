...
public class IntentUtils {
     ...
     */
    public static Intent getPickMultipleIntent(TContextWrap contextWrap, int limit, boolean supportGif) {
        ...
        intent.putExtra(Constants.INTENT_EXTRA_IS_SUPPORT_GIF, supportGif);
        return intent;
    }
